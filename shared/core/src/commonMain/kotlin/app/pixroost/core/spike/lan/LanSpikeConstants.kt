...
/** Spikes S-03 and S-04: ports, service types and messages shared by the phone and the PC. */
object LanSpikeConstants {
    /** The PC's HTTPS server listens here: the direct path, phone → PC. */
