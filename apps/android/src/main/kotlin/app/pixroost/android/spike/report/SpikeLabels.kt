...
import app.pixroost.android.spike.data.MediaStoreConstants
...
import app.pixroost.android.spike.util.oneDecimal
...
fun scanLabel(scan: ScanResult): String {
    ...
    return "Галерея: ${scan.items.size.formatted()} (видео ${videos.formatted()}). " +
        ...
        "первые ${MediaStoreConstants.FIRST_PAGE_SIZE} — ${scan.firstPageMillis} мс. $generation"
}
