<p align="center">
  <img src="docs/assets/logo.svg" width="112" alt="Логотип Homeroll">
</p>

<h1 align="center">Homeroll</h1>

<p align="center">
  <b>Твоя фотолента — дома.</b><br>
...
> [!NOTE]
> Homeroll на этапе **планирования** — кода пока нет. Здесь лежат план продукта, архитектура и конвенции.
...
Homeroll решает это, не продавая ещё больше места:
...
- **Без подписки.** Homeroll не хранит фото на своих серверах — платить не за что. Приложение бесплатное.
...
1. **Твои фото — твои.** Ничего не попадает на серверы Homeroll.
...
[Apache License 2.0](LICENSE). Название и логотип Homeroll лицензией не покрываются.
