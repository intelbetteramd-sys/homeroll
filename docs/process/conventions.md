...
- Вехи (Milestones) — этапы с названиями («Фундамент», «Проводка», «Крыша», «Генеральная уборка», «Новоселье»);
  номер версии — в описании вехи. Список — в [настройке репозитория](repository-setup.md#9-вехи).
