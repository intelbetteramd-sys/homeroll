...
- Исключение одно: Dependabot пишет «Bump» с заглавной (`ci: Bump the actions group…`), проверка это пропускает.
  При слиянии такого PR можно исправить заголовок коммита на строчную букву.
