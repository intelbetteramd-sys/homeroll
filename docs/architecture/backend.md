...
- После переустановки приложения в v1.0 источники индексируются заново. Копия базы на своём сервере для
  этого не нужна: в v1.2 невосстановимые данные вернёт ПК пользователя
  ([модель данных](data-model.md#после-переустановки)).
