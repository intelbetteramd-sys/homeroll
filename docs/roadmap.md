...
- [ ] Переименовать репозиторий в `homeroll`, сделать публичным, настроить защиту `main` ([CI/CD](tech/ci-cd.md#защита-main-настроить-вручную)).
- [ ] Лейблы и вехи в GitHub ([конвенции](process/conventions.md#5-issues-лейблы-вехи)).
...
- [ ] Сайт: лендинг, политика конфиденциальности, пользовательское соглашение, поддержка, FAQ.
