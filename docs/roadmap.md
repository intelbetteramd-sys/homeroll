...
| S-03 | Передача телефон → ПК: Ktor Server, самоподписанный сертификат, пиннинг, докачка; Android и iPhone (фоновая загрузка) | ≥ 20 МБ/с по Wi-Fi, докачка после обрыва |
